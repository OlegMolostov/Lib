...
<head>
    ...
    <title>Books That Are Read</title>
...
<div class="container">
    ...
    <table>
        ...
        <c:forEach var="tit" items="${titleOfBookThatAreReadList}">

            <c:url  var="bookInfo"  value="${contextPath}/bookInfo" >
                <c:param  name="book" value="${tit.titleOfBook.titleOfBookId}"/>
            </c:url>

            <c:url var="deleteButton" value="/deleteBooksThatAreRead">
            ...
            <tr>
                ...
                <td>${tit.titleOfBook.genre.typeGenre}</td>
                <td>
